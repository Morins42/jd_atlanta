...
class N2ElementWidgetPosition extends N2ElementGroup {
    ...
    protected function addAdvanced() {
        ...
        new N2ElementNumber($advanced, $this->name . '-horizontal-position', n2_('Position'), 0, array(
            'style' => 'width:30px;'
        ));
        ...
        new N2ElementNumber($advanced, $this->name . '-vertical-position', n2_('Position'), 0, array(
            'style' => 'width:30px;'
        ));
